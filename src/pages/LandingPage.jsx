    ...
    <div className="landing" id="top">
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <h1>
            Welcome to <span className="accent">Pulse</span>
          </h1>
          <p>
            Secure authentication for modern apps — sign-up, email verification,
            account protection, and password recovery, ready out of the box.
          </p>
          <div className="hero-cta">
            <Link to="/signup" className="lbtn lbtn-primary">
              Get Started
            </Link>
            <a href="#features" className="lbtn lbtn-ghost">
              Learn More
            </a>
          </div>
        </div>
      ...
      <section className="lsection" id="features">
        ...
        <p className="lsection-sub">
          A complete, production-ready auth layer — so you can focus on your
          product, not on security plumbing.
        </p>
      ...
      <section className="why" id="about">
        <div className="why-inner">
          <div>
            ...
            <p>
              Pulse handles the hard parts of authentication so your team
              doesn't have to — with sensible defaults and security baked in at
              every step.
            </p>
            <ul className="why-list">
              <li>
                <span className="tick">✓</span> bcrypt password hashing &amp;
                strict policy
              </li>
              <li>
                <span className="tick">✓</span> Verified emails before first
                login
              </li>
              <li>
                <span className="tick">✓</span> Account lockout &amp; IP rate
                limiting
              </li>
              <li>
                <span className="tick">✓</span> Expiring reset &amp;
                verification tokens
              </li>
            </ul>
            <div className="why-stats">
              <div className="why-stat">
                ...
                <div className="lbl">char passwords</div>
              </div>
              <div className="why-stat">
                <div className="num">JWT</div>
                <div className="lbl">+ refresh rotation</div>
              </div>
              <div className="why-stat">
                <div className="num">5</div>
                <div className="lbl">try lockout</div>
              </div>
            </div>
          </div>
      ...
      <section className="lsection lcta">
        <div className="lcta-box">
          ...
          <p>
            Create your Pulse account in seconds, or sign in to pick up where
            you left off.
          </p>
          <div className="lcta-buttons">
            ...
            <Link to="/login" className="lbtn lbtn-ghost">
              Sign In
            </Link>
          </div>
        </div>
